...
export default function Icon({ name, size = 18 }: IconProps) {
  ...
  switch (name) {
    ...
    case "eye-off":
      return (
        <svg {...p}>
          <path d="M9.9 4.2A10 10 0 0112 4c6.5 0 10 7 10 7a17 17 0 01-3 3.8M6.2 6.2A17 17 0 002 11s3.5 7 10 7a10 10 0 004-.8" />
          <path d="M3 3l18 18" />
        </svg>
      );
    case "chevL":
    ...
    case "chord":
      return (
        <svg {...p} strokeWidth="1.5">
          <path d="M5 4v16M9.5 4v16M14.5 4v16M19 4v16M5 9h14M5 15h14" />
        </svg>
      );
    case "arrow":
      return (
