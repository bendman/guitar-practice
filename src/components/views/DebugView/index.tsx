        ...
        <div className={shared.screenBodyInner}>
          ...
          <div className={s.block}>
            ...
            <div className={s.barTrack}>
              <div
                className={s.barFill}
                style={{ width: `${rmsPercent * 100}%`, background: rmsColor(rms) }}
              />
              <div
          ...
          <div className={s.block}>
            ...
            <div className={s.barTrack}>
              <div
                className={s.barFill}
                style={{ width: `${Math.min(corr, 1) * 100}%`, background: corrColor(corr) }}
              />
            </div>
            <div className={s.barCaption}>
              {corr.toFixed(3)}
          ...
          <div className={s.block}>
            ...
            <div className={s.spectrumCaption}>{freq ? `${freq.toFixed(1)} Hz` : "—"}</div>
          </div>
          ...
          <div className={s.block}>
            ...
            <div className={s.noteRow}>
              ...
              {noteInfo && (
                <div
                  className={`${s.centsBadge} ${withinThreshold ? s.centsBadgeGreen : s.centsBadgeAccent}`}
                >
                  {noteInfo.signedCents > 0 ? "+" : ""}
                  {noteInfo.signedCents}¢
                </div>
              )}
            </div>
            {noteInfo && (
